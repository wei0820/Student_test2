...
//            textView.setText("名稱："+records.Name);
            ...
            textView6.setText("開放時間："+records.Opentime);
            textView4.setText("門票："+records.Ticketinfo);
            textView5.setText("停車資訊："+records.Parkinginfo);
            textView8.setText("備註："+records.Remarks);
            textView7.setText("簡述："+records.Toldescribe);
        }
